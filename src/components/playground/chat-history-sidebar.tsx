...
import type { PlaygroundHistoryItem } from "./playground-editor";
...
interface ChatHistorySidebarProps {
  ...
  onSelectHistory: (item: PlaygroundHistoryItem) => void;
  onClearHistory: () => void;
  onNewChat: () => void;
}
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  This will permanently delete your entire Playground chat history. This action cannot be undone.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
