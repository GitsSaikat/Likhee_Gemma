...
import { FeedbackPanel } from "@/components/playground/feedback-panel";
...
export function PlaygroundEditor() {
  ...
  const [activeItem, setActiveItem] = useState<PlaygroundHistoryItem | null>(null);
  ...
  const saveHistory = (newHistory: PlaygroundHistoryItem[]) => {
